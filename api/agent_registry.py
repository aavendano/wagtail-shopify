...
CAPABILITIES: dict[str, AgentCapability] = {
    ...
    "preview_glossary_term": _cap(
        "preview_glossary_term", "GET", "/glossary/{page_id}/preview",
        "read", "glossary",
        "Preview Glossary page HTML (draft/latest revision)",
        "Render the Wagtail template for iframe preview in the CMS SPA without publishing to Shopify.",
        "text/html",
        (),
    ),
    "preview_product": _cap(
        "preview_product", "GET", "/products/{page_id}/preview",
        "read", "products",
        "Preview Product page HTML (draft/latest revision)",
        "Render the Wagtail template for iframe preview in the CMS SPA without publishing to Shopify.",
        "text/html",
        (),
    ),
    "preview_collection": _cap(
        "preview_collection", "GET", "/collections/{page_id}/preview",
        "read", "collections",
        "Preview Collection page HTML (draft/latest revision)",
        "Render the Wagtail template for iframe preview in the CMS SPA without publishing to Shopify.",
        "text/html",
        (),
    ),
    "preview_blog": _cap(
        "preview_blog", "GET", "/blogs/{page_id}/preview",
        "read", "blogs",
        "Preview Blog page HTML (draft/latest revision)",
        "Render the Wagtail template for iframe preview in the CMS SPA without publishing to Shopify.",
        "text/html",
        (),
    ),
    "preview_article": _cap(
        "preview_article", "GET", "/articles/{page_id}/preview",
        "read", "articles",
        "Preview Article page HTML (draft/latest revision)",
        "Render the Wagtail template for iframe preview in the CMS SPA without publishing to Shopify.",
        "text/html",
        (),
    ),
    "preview_location": _cap(
        "preview_location", "GET", "/locations/{page_id}/preview",
        "read", "locations",
        "Preview Location page HTML (draft/latest revision)",
        "Render the Wagtail template for iframe preview in the CMS SPA without publishing to Shopify.",
        "text/html",
        (),
    ),
