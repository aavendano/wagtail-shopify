...
from .common import FAQSchema, LocaleCreateFields, LocalePatchFields, LocaleOutFields, StorefrontUrlOutFields
...
class LocationOut(StorefrontUrlOutFields, LocaleOutFields):
