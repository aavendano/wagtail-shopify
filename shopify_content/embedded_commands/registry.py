...
EMBEDDED_COMMANDS: tuple[EmbeddedCommandSpec, ...] = (
    ...
    EmbeddedCommandSpec(
        ...
        description=(
            'Crea la Shopify Page de blog (page_gid) y muestra export_config de glossary/locations '
            '(locales → root_page) y blog (page_gid), sin escribir en Wagtail.'
        ),
        group='setup',
        when_to_use='Para previsualizar la config antes de aplicarla. Glossary/locations ya no usan Pages índice.',
    ),
    EmbeddedCommandSpec(
        ...
        description=(
            'Persiste export_config: glossary/locations con locales; blog con page_gid de la Page blogs.'
        ),
        group='setup',
        when_to_use='Al configurar los índices por primera vez, cuando ya validaste la salida de "Crear páginas índice".',
    ...
    EmbeddedCommandSpec(
        ...
        description='Crea o verifica las metafield definitions de tipo PAGE (blog index_listings).',
        group='setup',
        when_to_use='Durante el setup del índice de blog, o si el push de blog falla por metafield PAGE inexistente.',
    ),
    EmbeddedCommandSpec(
        id='ensure_index_metafield_definitions',
        command='ensure_index_metafield_definitions',
        label='Metafields de índices',
        description='Asegura custom.index_listings (PAGE, blog) y available_locales en BLOG/ARTICLE.',
        group='setup',
        when_to_use='Antes del primer rebuild del índice blog, o si el storefront no recibe custom.index_listings.',
    ),
    EmbeddedCommandSpec(
    ...
    EmbeddedCommandSpec(
        ...
        description='Reconstruye y empuja entradas root_page (una por locale, p. ej. glossary-en-us).',
        group='indexes',
    ...
    EmbeddedCommandSpec(
        ...
        description='Reconstruye y empuja entradas root_page (una por locale, p. ej. locations-en-us).',
        group='indexes',
